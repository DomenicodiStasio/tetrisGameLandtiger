...
// <<< Use Configuration Wizard in Context Menu >>>
  ...
  if ( timer_num == 0 )
  {
    ...
    // --- PRESCALER ---
    LPC_TIM0->PR  = 0;  // 0 = Nessun prescaler (Count = PCLK)
                        // N = Count = PCLK / (N+1)

// <h> timer0 MCR Configuration
//   <e.0> MR0I
...
//   </e>
//   <e.2> MR0S
//     <i> 1 Stop on MR0: the TC and PC will be stopped and TCR[1] will be set to 0 if MR0 matches the TC
//     <i> 0 Feature disabled.
//   </e>
//   <e.3> MR1I
//     <i> 1 Interrupt on MR1: an interrupt is generated when MR0 matches the value in the TC.
...
//   </e>
//   <e.2> MR0S
//     <i> 1 Stop on MR0: the TC and PC will be stopped and TCR[2] will be set to 0 if MR0 matches the TC
//     <i> 0 Feature disabled.
//   </e>
//   <e.3> MR1I
//     <i> 1 Interrupt on MR1: an interrupt is generated when MR0 matches the value in the TC.
...
// </h>
    ...
    NVIC_SetPriority(TIMER2_IRQn, 5);   /* Standard priority */
    return (1);
  }
  else if ( timer_num == 3 )
  {
...
//   </e>
//   <e.2> MR0S
//     <i> 1 Stop on MR0: the TC and PC will be stopped and TCR[3] will be set to 0 if MR0 matches the TC
//     <i> 0 Feature disabled.
//   </e>
//   <e.3> MR1I
//     <i> 1 Interrupt on MR1: an interrupt is generated when MR0 matches the value in the TC.
...
// </h>
    ...
    NVIC_SetPriority(TIMER3_IRQn, 5);   /* Standard priority */
    return (1);
  }
